...
?>
      ...
      <div class="container my-5 py-5">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <p class="text-center">
              <button href="#contact" class="btn btn-joinUs rounded-0 btn-lg me-5">Nous visiter</button>
              <button class="btn btn-sermon rounded-0 btn-lg">Prédications</button>
            </p>
          </div>
        </div>
    ...
    <section class="info py-5 bg-dark general_font" >
      <div class="container" >
        <h3 class="text-center title-color" id="about">Qui sommes-nous</h3>
        <div class="row py-4">
          <div class="card mb-3 border-0 rounded-0 p-0 ">
            <div class="row ">
              <div class="col-md-6 ">
                <img src="/images/communionF.jpeg" class="img-fluid " alt="..." >
              </div>
              <div class="col-md-6">
                <div class="card-body">
              ...
              <div class="col-md-6">
                <div class="card-body">
                  ...
                  <p class="card-text text-format">
                    ...
                    au mouvement d'églises <span> <a href="#" style="cursor: pointer;text-decoration: none;color: #d28503;">Greater Grace World Outreach, 
                    ...
                    Par la formation de pasteurs au sein du <a href="#" style="cursor: pointer;text-decoration: none;color: #d28503;">Maryland Bible College 
                      and Seminary (M.B.C.&S)</a> et par l’envoi de missionnaires, 
                    il est à l’origine de nombreuses églises dans le monde.
                  </p>
                  <p class="card-text"><a href="" class="text-muted btn">Lire la suite...</a></p>
                </div>
              </div>
              <div class="col-md-6">
                <img src="/images/assemblee1.jpg" class="img-fluid" alt="...">
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="agenda py-5 general_font">
      <div class="container">
        <h3 class="text-center title-color" id="agenda">Le programme de la semaine</h3>
    ...
    <section class="info py-5 bg-light general_font">
      <div class="container">
        <h3 class="text-center title-color" id="pastor">Le responsable</h3>
        <div class="row py-4">
          <div class="card mb-3 border-0 rounded-0 p-0">
            <div class="row ">
              <div class="col-md-6 ">
                <img src="/images/Famille2.jpeg" class="img-fluid " alt="..." >
              </div>
    ...
    <section class="info py-5 bg-dark general_font">
      <div class="container">
        <h3 class="text-center title-color" id="contact">Nous visiter</h3>
        <div class="row py-4">
          <div class="card mb-3 border-0 rounded-0 p-0">
            <div class="row ">
              <div class="col-md-6 ">
              ...
              <div class="col-md-6">
                <div class="card-body py-5">
                  ...
                  <form class="row g-3">
                    <div class="col-md-12">
                      <label for="inputEmail4" class="form-label">Votre nom et prénom</label>
                      <input type="email" class="form-control" id="inputEmail4">
                    </div>
                    <div class="col-12">
                      <label for="inputAddress" class="form-label">Votre numéro de téléphone</label>
                      <input type="text" class="form-control" id="inputAddress" >
                    </div>
                    <div class="col-12">
                      <label for="inputAddress2" class="form-label">Votre message</label>
                      <textarea type="text" cols="8" class="form-control" id="inputAddress2"></textarea>
                    </div>
    ...
    <section class="believe py-5 general_font">
      <div class="container">
        <h3 class="text-center title-color" id="believe">Ce que nous croyons</h3>
        <div class="row row-cols-2 row-cols-md-4 g-4 py-4">
          <div class="col">
            <div class="card rounded-0">
              <img src="/images/bible_believe.jpg" class="card-img-top" alt="...">
              <div class="card-body">
                <a href="" class="believe-title"><h6 class="card-title text-center">LA BIBLE</h6></a>
                <p class="card-text"></p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card rounded-0">
              <img src="/images/bible_believe.jpg" class="card-img-top" alt="...">
              <div class="card-body">
                <a href="" class="believe-title"><h6 class="card-title text-center">LA TRINITE</h6></a>
                <p class="card-text"></p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card rounded-0">
              <img src="/images/bible_believe.jpg" class="card-img-top" alt="...">
              <div class="card-body">
                <a href="" class="believe-title"><h6 class="card-title text-center">DIEU LE PERE</h6></a>
                <p class="card-text"></p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card rounded-0">
              <img src="/images/bible_believe.jpg" class="card-img-top" alt="...">
              <div class="card-body">
                <a href="" class="believe-title"><h6 class="card-title text-center">JESUS-CHRIST</h6></a>
                <p class="card-text"></p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card rounded-0">
              <img src="/images/bible_believe.jpg" class="card-img-top" alt="...">
              <div class="card-body">
                <a href="" class="believe-title"><h6 class="card-title text-center">LE SAINT-ESPRIT</h6></a>
                <p class="card-text"></p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card rounded-0">
              <img src="/images/bible_believe.jpg" class="card-img-top" alt="...">
              <div class="card-body">
                <a href="" class="believe-title"><h6 class="card-title text-center">L'HOMME</h6></a>
                <p class="card-text"></p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card rounded-0">
              <img src="/images/bible_believe.jpg" class="card-img-top" alt="...">
              <div class="card-body">
                <a href="" class="believe-title"><h6 class="card-title text-center">LE SALUT</h6></a>
                <p class="card-text"></p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card rounded-0">
              <img src="/images/bible_believe.jpg" class="card-img-top" alt="...">
              <div class="card-body">
                <a href="" class="believe-title"><h6 class="card-title text-center">L'EGLISE</h6></a>
                <p class="card-text"></p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card rounded-0">
              <img src="/images/bible_believe.jpg" class="card-img-top" alt="...">
              <div class="card-body ">
                <a href="" class="believe-title"><h6 class="card-title text-center">LE FUTUR DE L'EGLISE</h6></a>
                <p class="card-text"></p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card rounded-0">
              <img src="/images/bible_believe.jpg" class="card-img-top" alt="...">
              <div class="card-body">
                <a href="" class="believe-title"><h6 class="card-title text-center">LA FIN DES TEMPS</h6></a>
                <p class="card-text"></p>
              </div>
            </div>
          </div>
